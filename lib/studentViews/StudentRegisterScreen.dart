...
class StudentRegisterScreen extends StatefulWidget {
  ...
  const StudentRegisterScreen({Key key, @required this.features})
      : super(key: key);
...
class _StudentRegisterScreenState extends State<StudentRegisterScreen> {
  ...
  String get regnoError {
    String pattern = r"^[0-9]{10}";
    RegExp regExp = new RegExp(pattern);
    if (regno.isEmpty) {
      return 'Can\'t be empty';
    }
    if (!regExp.hasMatch(regno)) {
      return 'Invalid Fugus Reg. Number';
    }
    // return null if the text is valid
    return null;
  }
                ...
                children: <Widget>[
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: regnoNotValid ? regnoError : null,
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(32.0)),
                      focusedBorder: OutlineInputBorder(
                        borderSide:
                    ...
                    return GestureDetector(
                      ...
                      onTap: () async {
                        ...
                        FutureResponse result =
                            await handleNetworking.registerStudent(
                                email, name, password, regno, widget.features);
                            ...
                            Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => LoginScreen(
                                      msg:
                                          "Verification email sent. First verify your email then login to AMS FUGUS")),
